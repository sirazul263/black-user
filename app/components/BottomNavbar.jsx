...
const BottomNavbar = () => {
  ...
  return (
    <div
      ...
      style={{ zIndex: 100, borderTopLeftRadius: 16, borderTopRightRadius: 16 }}
    >
      <div className="d-flex align-items-center justify-content-between">
        ...
        <Link href={"/booking-history"} className="text-decoration-none ">
          <div className="text-center text-clr-primary">
            <svg
              width="25"
              height="25"
              viewBox="0 0 25 25"
